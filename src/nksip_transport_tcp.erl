...
-export([ranch_start_link/5, start_link/4]).
...
ranch_start_link(Ref, RanchTransp, TransOpts, Protocol, [AppId, Transp, Timeout]) ->
    case
        ranch_listener_sup:start_link(Ref, RanchTransp, TransOpts, Protocol, [AppId, Transp, Timeout])
    of
        {ok, Pid} ->
